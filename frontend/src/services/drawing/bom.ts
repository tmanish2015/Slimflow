import type { Bom, BomLine, DrawingFeature, ExtractedDimension, HardwareItem, PanelMaterial } from './store'
import { toMillimetres } from './dimensionParser'
 ...
 * dimensions and the editable rate master, not a model estimate.
 */
export function generateBom(
  ...
  const frameMm = firstValue(dimensions, 'frame')
